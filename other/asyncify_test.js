...
var wasmBinaryFile;
  wasmBinaryFile = 'asyncify_test.wasm';
...
function __asyncjs__do_fetch() { return Asyncify.handleAsync(async () => { out("waiting for a fetch"); const response = await fetch("a.html"); out("got the fetch response"); return 42; }); }
...
var ___start_em_js = Module['___start_em_js'] = 1192;
var ___stop_em_js = Module['___stop_em_js'] = 1358;
